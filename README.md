...
- Escolha apenas um template para se basear.
- Não é necessário reproduzir exatamente igual, fique a vontade para usar sua criatividade.
- A atividade deve ser entregue a partir do envio do link do repositório no GitHub.
